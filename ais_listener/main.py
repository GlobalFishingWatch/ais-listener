...
parser.add_argument(
    "--test",
    action="store_true",
    help="Test mode - this setting is currently ignored.  Use -v or -vv when testing",
    default=False,
)
...
receiver_args = subparsers.add_parser(
    "receiver", help="receive nmea lines from a TCP ot UDP transmitter"
)
...
receiver_args.add_argument(
    "--buffer-size",
    type=int,
    help="size in bytes for the internal buffer" "(default: %(default)s)",
    default=4096,
)
receiver_args.add_argument(
    "--gcs-dir",
    type=str,
    help="GCS directory to write nmea shard files" "(default: %(default)s)",
    default="gs://scratch-paul-ttl100/ais-listener/",
)
receiver_args.add_argument(
    "--config_file",
    type=str,
    help="File to read to get mapping of listening ports to source names" "(default: %(default)s)",
...
transmitter_args.add_argument(
    "--protocol", type=str, help="UDP or TCP (default: %(default)s)", default="UDP"
)
transmitter_args.add_argument(
    "--receiver-ip",
    type=str,
...
transmitter_args.add_argument(
    "--port", type=int, help="UDP/TCP port (default: %(default)s)", default=10110
)
transmitter_args.add_argument(
    "--filename",
    type=str,
